...
- Flagship models: >=150B parameters (or undisclosed flagship sizes), released through 2025-11-24.
...
- `open reports/combined_report.md` — narrative report for open models.
- `reports/combined_report.md` — narrative report for flagship models.
- `reports/open_report.md` — report pointer for open models.
...
4. Update `open reports/combined_report.md` with a short narrative and sources.
